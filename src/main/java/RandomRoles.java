...
public class RandomRoles {
    ...
    public ArrayList<String> setRandomGoodRoles(){
        ...
        ArrayList<String> randomGood= new ArrayList<String>();
    ...
    public ArrayList<String> setRandomBadRoles(){
        ...
        ArrayList<String> randomBad= new ArrayList<String>();
    ...
    public ArrayList<String> setRandomNeutralRoles(){
        ...
        ArrayList<String> randomNeutral= new ArrayList<String>();
    ...
    public ArrayList<String> joinAllList(){
        ...
        ArrayList<String> finalList= good;
        finalList.addAll(bad);
        finalList.addAll(neutral);
        randomFinalList=finalList;
        return finalList;
    }
